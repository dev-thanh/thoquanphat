    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <form action="{!! route('advisory.postMultiDel') !!}" method="POST">
    ...
    <script>
        jQuery(document).ready(function($) {
            $('#table-ajax').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('get.list.advisory') !!}',
                columns: [
                    { data: 'checkbox', name: 'checkbox' },
                    { data: 'DT_RowIndex',name: 'DT_RowIndex'},
                    { data: 'name', name: 'name' },
                    { data: 'phone', name: 'phone' },
                    { data: 'building_site', name: 'building_site' },
                    { data: 'advisory_content', name: 'advisory_content' },
