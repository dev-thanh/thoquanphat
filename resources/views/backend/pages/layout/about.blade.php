               	...
               	<form action="{{ route('pages.build.post') }}" method="POST">
					...
					<div class="nav-tabs-custom">
				        <ul class="nav nav-tabs">
				        	...
				        	<li class="">
				            	<a href="#introduce" data-toggle="tab" aria-expanded="true">Giới thiệu về Quang Thọ Phát</a>
				            </li>
				            <!-- <li class="">
				            	<a href="#content-1" data-toggle="tab" aria-expanded="true">Sứ Mệnh</a>
				            </li> -->
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="content[introduce][title_2]" value="{{ @$content->introduce->title_2 }}">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
