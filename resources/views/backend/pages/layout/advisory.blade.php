               	...
               	<form action="{{ route('pages.build.post') }}" method="POST">
					...
					<div class="nav-tabs-custom">
				        <ul class="nav nav-tabs">
				            <li class="active">
				            	<a href="#content" data-toggle="tab" aria-expanded="true">Khối gửi phản hồi cho chúng tôi</a>
				            </li>
				            <li class="">
			            ...
			            <div class="tab-pane active" id="content">
							<div class="row">
								<div class="col-sm-12">
									<div class="">
										<div class="form-group">
				                           <label>Hình ảnh đại diện bên phải</label>
				                           <div class="image">
				                               <div class="image__thumbnail">
				                                   <img src="{{ @$content->background_right ?  url('/').@$content->background_right : __IMAGE_DEFAULT__ }}"  
				                                   data-init="{{ __IMAGE_DEFAULT__ }}">
				                                   <a href="javascript:void(0)" class="image__delete" onclick="urlFileDelete(this)">
				                                    <i class="fa fa-times"></i></a>
				                                   <input type="hidden" value="{{ @$content->background_right }}" name="content[background_right]"  />
									...
									<div class="form-group">
										<label for="">Địa chỉ email khối</label>
										<textarea name="content[email]" 
										class="form-control" rows="5">{{ @$content->email }}</textarea>
									</div>
								</div>
							</div>
						</div>
