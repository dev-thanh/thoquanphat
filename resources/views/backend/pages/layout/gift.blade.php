				    ...
				    <div class="tab-content">
			            <div class="tab-pane active" id="seo">
							<div class="row">
								...
								<div class="col-sm-2">
									<div class="form-group">
			                           <label>Background sản phẩm nổi bật</label>
			                           <div class="image">
			                               <div class="image__thumbnail">
			                                   <img src="{{ @$content->background_main_footer ?  url('/').@$content->background_main_footer : __IMAGE_DEFAULT__ }}"  
			                                   data-init="{{ __IMAGE_DEFAULT__ }}">
			                                   <a href="javascript:void(0)" class="image__delete" onclick="urlFileDelete(this)">
			                                    <i class="fa fa-times"></i></a>
			                                   <input type="hidden" value="{{ @$content->background_main_footer }}" name="content[background_main_footer]"  />
			                                   <div class="image__button" onclick="fileSelect(this)"><i class="fa fa-upload"></i> Upload</div>
			                               </div>
			                           </div>
			                       </div>
