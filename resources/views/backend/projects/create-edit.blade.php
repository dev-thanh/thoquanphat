...
@section('controller', 'Danh sách dự án hoàn thành')
		                    	...
		                    	<div class="row">
		                    		...
		                    		<div class="col-sm-12">
		                    			<div class="form-group">
		                                    <label>Tên dự án hoàn thành</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
		                                	<label for="">Thông tin chi tiết dự án</label>
				...
				<div class="col-sm-3">
					<div class="box box-success">
		                <div class="box-header with-border">
		                    <h3 class="box-title">Đăng dự án hoàn thành</h3>
		                </div>
		                <div class="box-body">
		                    <div class="form-group">
		                        ...
		                        <label class="custom-checkbox">
		                        	@if(isUpdate(@$module['action']))
		                            	<input type="checkbox" name="hot" value="1" {{ @$data->hot == 1 ? 'checked' : null }}> Dự án tiêu biểu
		                            @else
		                            	<input type="checkbox" name="hot" value="1" checked> Dự án tiêu biểu
		                            @endif
		                        </label>
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
		                    <h3 class="box-title">Danh mục dự án hoàn thành</h3>
		                </div>
