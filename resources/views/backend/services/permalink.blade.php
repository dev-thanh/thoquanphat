...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('dich-vu/chi-tiet/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('dich-vu/chi-tiet') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('dich-vu/chi-tiet') }}">
