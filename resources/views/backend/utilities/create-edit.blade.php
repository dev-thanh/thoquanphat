...
@section('controller', 'Danh sách tiện ích')
                ...
                <div class="col-sm-9">
					<div class="nav-tabs-custom">
		                <ul class="nav nav-tabs">
		                    <li class="active">
		                        <a href="#activity" data-toggle="tab" aria-expanded="true">Thông tin tiện ích</a>
		                    </li>
		                    <li class="">
		                        <a href="#gallery" data-toggle="tab" aria-expanded="true">Thêm ảnh tiện ích</a>
		                    </li>
							<li class="">
		                ...
		                <div class="tab-content">
		                    ...
		                    <div class="tab-pane active" id="activity">
		                    	<div class="row">
		                    		...
		                    		<div class="col-sm-12">
		                                ...
		                                @if(isUpdate(@$module['action']))
			                                <div class="form-group" id="edit-slug-box">
			                                    @include('backend.utilities.permalink')
			                                </div>
		                                @endif
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="">Mô tả tiện ích</label>
                                            <textarea class="content" name="desc">{!! old('desc', @$data->desc) !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
		                                	<label for="">Thông tin chi tiết tiện ích</label>
				...
				<div class="col-sm-3">
					<div class="box box-success">
		                <div class="box-header with-border">
		                    <h3 class="box-title">Đăng tiện ích</h3>
		                </div>
		                <div class="box-body">
		                    <div class="form-group">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
		                    <h3 class="box-title">Danh mục tiện ích</h3>
		                </div>
		            ...
		            <div class="box box-success">
		                <div class="box-header with-border">
		                    <h3 class="box-title">Ảnh tiện ích</h3>
		                </div>
		                <div class="box-body">
