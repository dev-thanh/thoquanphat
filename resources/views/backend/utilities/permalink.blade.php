...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('tien-ich/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('tien-ich') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('tien-ich') }}">
