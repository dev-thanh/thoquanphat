...
@section('main')
	...
	<main id="main" class=" ">
	    ...
	    @if(count($beautiful_house_same_category) > 0)
	            ...
	            <div class="module module__relate-to">
	                ...
	                <div class="module__content">
	                    <div class="relate__group">
	                    	@foreach($beautiful_house_same_category as $item)
	                            ...
	                            <div class="relate__box">
	                                ...
	                                <div class="relate__content">
	                                    ...
	                                    <div class="text-center">
	                                        <a href="{{route('home.beautiful-house-detail',['slug'=>$item->slug])}}" class="btn btn__link"> Chi tiết </a>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
