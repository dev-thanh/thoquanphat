...
@section('main')
	...
	<main id="main" class=" ">
	    ...
	    @if(count($quotes_same_category) > 0)
	    <section class="relate-to">
	        <div class="container">
	            <div class="module module__relate-to">
	                <div class="module module__header">
	                    <h2 class="title">
	                    	@if(!empty(@$site_info->icon_bvlq))
	                        <img src="{{ url('/').@$site_info->icon_bvlq }}" alt="icon__relate--to.png" />
	                        @endif
	                        Bài viết liên quan
	                    </h2>
	                </div>
	                <div class="module__content">
	                    <div class="relate__group">
	                    	@foreach($quotes_same_category as $item)
