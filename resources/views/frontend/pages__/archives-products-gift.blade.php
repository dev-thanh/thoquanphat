        ...
        <section class="sanpham_banchay all_sp--page">
            <div class="container">
                <div class="title_section">
                    <h2 class="h2_title"><span>Tất cả sản phẩm gift</span></h2>
                </div>
                <div class="content_section">
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                            @include('frontend.teamplate.category-products-gift')
                                                ...
                                                <div class="list_sp--moi">
                                                    ...
                                                    <div class="item_sp--moi">
                                                        <div class="img_sp img-cover">
                                                            <a href="{{route('home.single-product-gift',['slug'=>$item->slug])}}"><img src="{{url('/').@$item->image}}" alt="{{$item->name}}"></a>
                                                        </div>
                                                        <div class="text_sp">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 cus__mb-4">
                                    @include('frontend.pages.product-item.product-item2')
                                </div>
                                @endforeach
                            </div>
                            <div class="row mt-5">
                        ...
                        <div class="item">
                            <div class="item_news">
                                <div class="img_news img-cover">
                                    <a href="{{route('home.single-product-gift',['slug'=>$item->slug])}}"><img src="{{url('/').@$item->image}}" alt=""></a>
                                </div>
                                <div class="text_news">
                                    <div class="date_time">
                                    ...
                                    <div class="text">
                                        ...
                                        <a href="{{route('home.single-product-gift',['slug'=>$item->slug])}}" class="btn btn-default btn_xemthem">Xem thêm</a>
                                    </div>
                                </div>
                            </div>
                        </div>
